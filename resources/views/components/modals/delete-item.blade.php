...
<button data-modal-target="delete-item-{{ $id }}" data-modal-toggle="delete-item-{{ $id }}" class="text-white inline-flex items-center bg-red-700 hover:bg-red-500 dark:hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center transiontion duration-300 ease-in-out hover:scale-110 active:scale-90" type="button">
